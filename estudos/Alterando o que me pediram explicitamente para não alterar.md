...
Então vamos deixar o repositório bem arrumadinho com as configurações úteis.

# PlatformIO

Iniciando com a instalação do arquivos, parece que foi tudo feito automaticamente, e eu não precisaria fazer a instalação do zero com o [script de instalação](../docs/INSTALL) 

Porém isso leva um tempo e eu não faço ideia do que eles estão fazendo no meu computador.
...
Não seria muito melhor usar o cmake por pasta ?